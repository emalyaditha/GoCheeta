...
public class CustomerController {
    ...
    public String customerHome(@ModelAttribute("customer") Customer user,Model model, RedirectAttributes ra ) {
    ...
    public String booking(@ModelAttribute("customer") Customer user, Model model, RedirectAttributes rs) {
        ...
        Customer oauthUser = service.log(user.getEmail(),user.getPassword());
        CustomerController obj = new CustomerController();
        String name = obj.login();
        model.addAttribute("pageTitle", "Edit User (ID: " + user.getEmail() + ")");
